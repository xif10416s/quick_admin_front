<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator"
      ...
      <a-button @click="handleAddUserDepart"
                type="primary"
                icon="plus">添加已有用户</a-button>
      <a-button @click="handleAdd"
                type="primary"
                icon="plus"
                style="margin-top: 16px">新建用户</a-button>
        ...
        <span slot="action"
          ...
          <a-dropdown>
            ...
            <a-menu slot="overlay">
                <a-menu-item>
                <a href="javascript:;"
                   @click="handleDeptRole(record)">分配部门角色</a>
              </a-menu-item>

              <a-menu-item>
                <a href="javascript:;"
                   @click="handleDetail(record)">用户详情</a>
              </a-menu-item>

              <a-menu-item>
                <a-popconfirm title="确定取消与选中部门关联吗?"
    ...
    <Select-User-Modal ref="selectUserModal"
                       @selectFinished="selectOK"></Select-User-Modal>
