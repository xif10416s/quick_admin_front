...
<script>
  ...
  import DeptUserInfo from '../system/modules/DeptUserInfo'
  import {queryDepartUserTreeList, searchByKeywords} from '@/api/api'
  import {JeecgListMixin} from '@/mixins/JeecgListMixin'
  import DeptRoleInfo from '../system/modules/DeptRoleInfo'

  export default {
    name: 'CommentUserManager',
    components: {
      DeptRoleInfo,
      DeptBaseInfo,
      DeptUserInfo,
