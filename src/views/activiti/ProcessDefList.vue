  ...
  export default {
      ...
      return {
        ...
        columns: [
          ...
          },
          {
            ...
            scopedSlots: {customRender: 'diagramResource'}
          },
          {
            title: '启用状态',
            align: "center",
        ...
        url: {
          ...
          uploadProcess: "/activiti/uploadworkflow",
    ...
    methods: {
      getDiagramUrl: function (record) {
        return window._CONFIG['domianURL']+"/activiti/showResource?processDefId="+record.id+"&resource="+record.diagramResourceName;
      },
